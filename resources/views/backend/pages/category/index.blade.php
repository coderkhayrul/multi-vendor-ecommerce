...
<div class="card">
    <div class="card-header">
        <p style="float:left" class="d-inline mb-0">All Category</p>
        <a style="float:right" class="d-inline btn btn-sm btn-primary" href="{{ route('category.create') }}">Create
            Category</a>
    </div>
    <div class="card-body">
            ...
            <tbody class="text-alian-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img class=" img-fluid rounded wd-50" src="{{ asset('backend/uploads/category/'.$data->category_image) }}"
                        alt="category_image">
                        @else
                    ...
                    <td > {{Str::limit($data->category_description, 40, $end=' .......')}}</td>
                    <td>
                        @if ($data['category_status'])
                        <a class="btn btn-success btn-sm" href="{{ route('category.deactive',$data->category_slug) }}">Active</a>
                        @else
                        <a class="btn btn-danger btn-sm" href="{{ route('category.active',$data->category_slug) }}">Deactive</a>
                        @endif
                    </td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu pd-10 wd-200">
                                <nav class="nav nav-style-2 flex-column">
                                    <a href="{{ route('category.edit',$data->category_slug) }}" class="nav-link"><i class="icon ion-compose"></i> Edit</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Are You Sure Went To Delete This Category !
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                <a href="{{ route('category.destroy',$data->category_slug) }}" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
