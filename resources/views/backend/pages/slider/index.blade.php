...
<div class="card">
    <div class="card-header">
        <p style="float:left" class="d-inline mb-0">All Slider</p>
        <a style="float:right" class="d-inline btn btn-sm btn-primary" href="{{ route('slider.create') }}">Create
            Slider</a>
    </div>
    <div class="card-body">
            ...
            <tbody class="text-alian-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img class=" img-fluid rounded wd-50" src="{{ asset('backend/uploads/slider/'.$data->slider_image) }}"
                        alt="slider_image">
                        @else
                    ...
                    <td > {{Str::limit($data->slider_description, 40, $end=' .......')}}</td>
                    <td>
                        @if ($data['slider_status'])
                        <a class="btn btn-success btn-sm" href="{{ route('slider.deactive',$data->id) }}">Active</a>
                        @else
                        <a class="btn btn-danger btn-sm" href="{{ route('slider.active',$data->id) }}">Deactive</a>
                        @endif
                    </td>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu pd-10 wd-200">
                                <nav class="nav nav-style-2 flex-column">
                                    <a href="{{ route('slider.edit',$data->id) }}" class="nav-link"><i class="icon ion-compose"></i> Edit</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('slider.destroy',$data->id) }}" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
