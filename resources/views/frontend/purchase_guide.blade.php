                        ...
                        <div class="col-lg-9">
                            <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                                ...
                                <figure class="border-radius-15 mb-30">
                                    <img class="border-radius-15" src="{{ asset('frontend') }}/imgs/page/guide-1.png" alt="">
                                </figure>
                        ...
                        <div class="col-lg-3 primary-sidebar sticky-sidebar">
                            <div class="widget-area">
                                ...
                                <div class="sidebar-widget widget-category-2 mb-30">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-1.svg" alt="">Milks & Dairies</a><span class="count">30</span>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-2.svg" alt="">Clothing</a><span class="count">35</span>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-3.svg" alt="">Pet Foods </a><span class="count">42</span>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-4.svg" alt="">Baking material</a><span class="count">68</span>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="{{ asset('frontend') }}/imgs/theme/icons/category-5.svg" alt="">Fresh Fruit</a><span class="count">87</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                                    ...
                                    <div class="single-post clearfix">
                                        <div class="image">
                                            <img src="{{ asset('frontend') }}/imgs/shop/thumbnail-6.jpg" alt="#">
                                        </div>
                                        <div class="content pt-10">
