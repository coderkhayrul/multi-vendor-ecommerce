                            ...
                            <div class="login_wrap widget-taber-content background-white">
                                <div class="padding_eight_all bg-white">
                                    <div class="heading_s1">
                                        ...
                                        <p class="mb-30">Already have an account? <a href="{{ route('frontend.user_login') }}">Login</a></p>
                                    </div>
                                    <form method="post" action="{{ route('register') }}">
                                        ...
                                        <div class="login_footer form-group">
                                            <div class="chek-form">
                                                <input class=" @error('security_code') is-invalid @enderror"" type="text" name="security_code" placeholder="Security code *">
                                                @error('security_code')
                                        ...
                                        <div class="payment_option mb-50">
                                            <div class="custome-radio">
                                                <input value="3" class="form-check-input" required="" type="radio" name="role" id="exampleRadios3" checked="">
                                            ...
                                            <div class="custome-radio">
                                                <input value="2" class="form-check-input" required="" type="radio" name="role" id="exampleRadios4">
