                        ...
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-1.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                            ...
                            <div class="mb-30">
                                ...
                                <div class="vendor-info d-flex justify-content-between align-items-end mt-30">
                                    <ul class="contact-infor text-muted">
                                        <li><img src="{{ asset('frontend') }}/imgs/theme/icons/icon-location.svg" alt=""><strong>Address:
                                            </strong> <span>5171 W Campbell Ave undefined Kent, Utah 53127 United
                                                States</span></li>
                                        <li><img src="{{ asset('frontend') }}/imgs/theme/icons/icon-contact.svg" alt=""><strong>Call
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        ...
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-7.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-8.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                        ...
                        <div class="vendor-content-wrap">
                            <div class="mb-30">
                                ...
                                <h4 class="mb-5"><a href="vendor-details-1.html">Red Baron</a></h4>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        ...
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-2.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                        ...
                        <div class="vendor-content-wrap">
                            <div class="mb-30">
                                ...
                                <h4 class="mb-5"><a href="vendor-details-1.html">Noodle Soup</a></h4>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-3.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                        ...
                        <div class="vendor-content-wrap">
                            <div class="mb-30">
                                ...
                                <h4 class="mb-5"><a href="vendor-details-1.html">Maruchan Ram</a></h4>
                                <div class="product-rate-cover">
                                    <div class="product-rate d-inline-block">
                                        <div class="product-rating" style="width: 90%"></div>
                                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-9.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-10.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
                ...
                <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                    <div class="vendor-wrap style-2 mb-40">
                        <div class="vendor-img-action-wrap">
                            <div class="vendor-img">
                                <a href="vendor-details-1.html">
                                    <img class="default-img" src="{{ asset('frontend') }}/imgs/vendor/vendor-4.png" alt="">
                                </a>
                            </div>
                            <div class="mt-10">
