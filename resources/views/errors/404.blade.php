        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-10 col-md-12 m-auto text-center">
                    <p class="mb-20"><img src="{{ asset('frontend') }}/imgs/page/page-404.png" alt="" class="hover-up"></p>
                    ...
                    <a class="btn btn-default submit-auto-width font-xs hover-up mt-30" href="{{ route('frontend.home') }}"><i class="fi-rs-home mr-5"></i> Back To Home Page</a>
                </div>
            </div>
        </div>
    </div>
